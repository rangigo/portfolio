export const projects = [
  ...
  },
  {
    ...
    itemTitleColor: '##fff',
    link: 'https://github.com/rangigo/shary',
    projectTitle: 'Shary',
    itemTitle: 'Shary',
    tech: 'Full-Stack',
    date: 'August 2018',
    status: 'On-going...',
    description:
      'A social network platform where you can share your stories. Built with MERN stack.',
  },
  {
    flex: 0.333,
    ...
    status: 'Finished',
    description:
      'A web app to note down video ideas, integrated with user login system.',
  },
  {
    flex: 0.333,
    backgroundColor: '#ccc',
